...
You can check if a receiver exists in the Brifle system by providing their personal information. This is useful for verifying if a user is registered before performing actions like sending them a document.
